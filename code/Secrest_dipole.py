...
class SecrestDipole():
    ...
    def __init__(self,
                    ...
                    initial_catfn,
                    mag, maglim,
                    mask_fn='/work2/08811/aew492/frontera/lss-dipoles/data/catalogs/masks/mask_master_hpx_r1.0.fits',
                    blim=30,
                    Rv=3.1,
                    delRW=0,
                    badd=1,
                    ...
                    log=True,
                    newlog=True,
                    basedir='/work2/08811/aew492/frontera/lss-dipoles/data/catalogs',
                    save_tag=''):
